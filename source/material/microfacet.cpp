...
float Microfacet::normalDistribution(const glm::vec3 &microfacet_normal) const {
...
float Microfacet::masking(const glm::vec3 &view_direction, const glm::vec3 &microfacet_normal) const {
...
float Microfacet::heightCorrelatedMaskingShadowing(const glm::vec3 &light_direction, const glm::vec3 &view_direction, const glm::vec3 &microfacet_normal) const {
...
float Microfacet::visibleNormalDistribution(const glm::vec3 &view_direction, const glm::vec3 &microfacet_normal) const {
    glm::vec3 view_direction_upper = view_direction.y > 0 ? view_direction : -view_direction;
...
glm::vec3 Microfacet::sampleVisibleNormal(const glm::vec3 &view_direction, const RNG &rng) const {
    glm::vec3 view_direction_upper = view_direction.y > 0 ? view_direction : -view_direction;
...
bool Microfacet::isDeltaDistibution() const {
...
float Microfacet::Lambda(const glm::vec3 &direction_upper) const {
